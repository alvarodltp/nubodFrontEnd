      ...
      <Table celled compact definition>
          ...
          <Table.Footer fullWidth>
            <Table.Row>
              ...
              <Button negative floated='right' size='tiny' onClick={(e) => {this.props.updateWorkoutHistory(oldWorkout.id); this.props.removeWorkout(e, oldWorkout.id); this.props.setSelectedWorkoutHistoryNull(); this.props.history.push('/workout-history')}}>Delete</Button>
