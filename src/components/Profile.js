    ...
    {this.state.edit === false ?
      <Grid id="profile-info" columns='three' divided>
          ...
          <Grid.Row>
            ...
            <Grid.Column>
              {this.props.user ? <h3>Calories: {this.props.user.calories}</h3> : null}
            </Grid.Column>
          </Grid.Row>
          ...
          <div id="profile-edit-button">
            <Button id="edit-button" color="gray" size="small" onClick={this.convertToInput} user={this.state.user}>Edit Profile</Button>
          </div>
