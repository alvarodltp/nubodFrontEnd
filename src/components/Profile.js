    ...
    return (
      ...
      <div id='header-site'>
        ...
        <div className="container space-around">
          {this.props.user ? <h1>{this.props.allWeightLifted} lb. Lifted</h1> : null}
          {this.props.user ? <h1>{this.props.allRepsLifted} Reps Completed</h1> : null}
          {this.props.user ? <h1>{this.props.workoutsCompleted} Workouts Killed</h1> : null}
